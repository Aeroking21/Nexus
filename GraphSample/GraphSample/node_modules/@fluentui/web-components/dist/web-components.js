  ...
  constructor() {
    ...
    this.updateLayout = () => {
      ...
      if (!this.initialLayoutComplete) {
        ...
        DOM.queueUpdate(() => this.$emit("loaded", this, {
          bubbles: false
        }));
      }
...
class FormAssociatedButton extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
...
class FormAssociatedCheckbox extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
    this.proxy = document.createElement("input");
  }
...
class FormAssociatedCombobox extends FormAssociated(ComboboxListbox) {}
...
class DataGrid extends FASTElement {
  constructor() {
    ...
    this.focusOnCell = (rowIndex, columnIndex, scrollIntoView) => {
      if (this.rowElements.length === 0 || this.columnDefinitions === null || this.columnDefinitions.length === 0) {
        this.focusRowIndex = 0;
        this.focusColumnIndex = 0;
        return;
      }
  ...
  disconnectedCallback() {
    ...
    this.removeEventListener(eventKeyDown, this.handleKeydown); // disconnect observer
  ...
  handleFocusin(e) {
    ...
    switch (this.cellType) {
      case DataGridCellTypes.columnHeader:
        if (this.columnDefinition.headerCellInternalFocusQueue !== true && typeof this.columnDefinition.headerCellFocusTargetCallback === "function") {
      ...
      default:
        if (this.columnDefinition.cellInternalFocusQueue !== true && typeof this.columnDefinition.cellFocusTargetCallback === "function") {
          // move focus to the focus target
...
function cacheCallbackResult(fun) {
  return function (handler, requestor, resolver) {
    if (cache$1.has(resolver)) {
      return cache$1.get(resolver);
    }

    const t = fun(handler, requestor, resolver);
    cache$1.set(resolver, t);
    return t;
  };
}
/**
  ...
  constructor() {
    ...
    this.trapFocusChanged = () => {
      if (this.trapFocus) {
        ...
        this.tabbableElements = tabbable_1(this); // Add an event listener for focusin events if we should be trapping focus
...
const ListboxTemplate = html`<template aria-activedescendant="${x => x.ariaActiveDescendant}" class="listbox" role="${x => x.role}" tabindex="${x => !x.disabled ? "0" : null}" @click="${(x, c) => x.clickHandler(c.event)}" @focusin="${(x, c) => x.focusinHandler(c.event)}" @keydown="${(x, c) => x.keydownHandler(c.event)}"><slot ${slotted({
  filter: Listbox.slottedOptionFilter,
  flatten: true,
  property: "slottedOptions"
})}></slot></template>`;
  ...
  setFocus(focusIndex, adjustment) {
    ...
    while (inRange(focusIndex, children.length)) {
      ...
      if (this.isFocusableElement(child)) {
        ...
        children[this.focusIndex].setAttribute("tabindex", "-1"); // update the focus index
...
class FormAssociatedTextField extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
    this.proxy = document.createElement("input");
  }
...
class FormAssociatedNumberField extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
    this.proxy = document.createElement("input");
  }
...
class NumberField extends FormAssociatedNumberField {
  ...
  stepUp() {
    ...
    const nextValue = this.max !== undefined && steppedValue > this.max ? this.max : steppedValue;
  ...
  stepDown() {
    const steppedValue = parseFloat(this.value) - this.step;
    const nextValue = this.min !== undefined && steppedValue < this.min ? this.min : steppedValue;
    this.value = parseFloat(nextValue.toPrecision(12)).toString();
  }
  /**
   * @internal
...
class FormAssociatedRadio extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
    this.proxy = document.createElement("input");
  }
...
class HorizontalScroll extends FASTElement {
  constructor() {
    ...
    this.startObservers = () => {
      ...
      this.stopObservers();
      (_a = this.resizeDetector) === null || _a === void 0 ? void 0 : _a.observe(this);
    };
    /**
     * Stops observers
     * @internal
    ...
    this.stopObservers = () => {
      ...
      (_a = this.resizeDetector) === null || _a === void 0 ? void 0 : _a.disconnect();
    };
    /**
     * Handle resize events
     * @internal
  ...
  initializeResizeDetector() {
    this.disconnectResizeDetector();
    this.resizeDetector = new window.ResizeObserver(this.handleResize.bind(this));
  }
  /**
...
__decorate([attr], HorizontalScroll.prototype, "speed", void 0);
...
const HorizontalScrollTemplate = html`<template role="horizontal-scroll" class="horizontal-scroll">${startTemplate}<div class="scroll-area"><div class="scroll-view" @scroll="${x => x.scrolled()}" ${ref("scrollContainer")}><div class="content-container"><slot ${slotted({
...
class FormAssociatedSelect extends FormAssociated(class extends Listbox {
  constructor() {
    super(...arguments);
...
class FormAssociatedSlider extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
    this.proxy = document.createElement("input");
  }
...
class FormAssociatedSwitch extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
    this.proxy = document.createElement("input");
  }
...
class FormAssociatedTextArea extends FormAssociated(class extends FASTElement {
  constructor() {
    super(...arguments);
...
function accentForegroundAlgorithm(contrastTarget) {
  return designSystem => {
    ...
    const accessibleSwatch = swatchByContrast(backgroundColor)(accentPalette)(() => startIndex)(() => direction)(swatchContrast => swatchContrast >= contrastTarget)(designSystem); // One of these will be rest, the other will be hover. Depends on the offsets and the direction.
...
__decorate$2([designSystemProperty({
...
FluentDesignSystemProvider = __decorate$2([designSystemProvider({
...
FluentAccordionItem = __decorate$2([customElement({
...
FluentAccordion = __decorate$2([customElement({
...
const AnchorStyles$1 = css` ${BaseButtonStyles}`.withBehaviors(appearanceBehavior('accent', AccentButtonStyles), appearanceBehavior('hypertext', HypertextStyles), appearanceBehavior('lightweight', LightweightButtonStyles), appearanceBehavior('outline', OutlineButtonStyles), appearanceBehavior('stealth', StealthButtonStyles));
...
__decorate$2([attr], FluentAnchor.prototype, "appearance", void 0);

FluentAnchor = __decorate$2([customElement({
  name: 'fluent-anchor',
...
const AnchoredRegionStyles$1 = css` :host{contain: layout;display: block}`;
...
FluentAnchoredRegion = __decorate$2([customElement({
...
const BadgeStyles$1 = css` ${display('inline-block')} :host{box-sizing: border-box;font-family: var(--body-font);font-size: var(--type-ramp-minus-1-font-size);line-height: var(--type-ramp-minus-1-height)}.control{border-radius: calc(var(--corner-radius) * 1px);padding: calc(var(--design-unit) * 0.5px) calc(var(--design-unit) * 1px)}:host(.lightweight) .control{background: transparent;color: ${neutralForegroundRestBehavior.var};font-weight: 600}:host(.accent) .control{background: ${accentFillRestBehavior.var};color: ${accentForegroundCutRestBehavior.var}}:host(.neutral) .control{background: ${neutralFillRestBehavior.var};color: ${neutralForegroundRestBehavior.var}}`.withBehaviors(accentFillRestBehavior, accentForegroundCutRestBehavior, neutralFillRestBehavior, neutralForegroundRestBehavior);
...
FluentBadge = __decorate$2([customElement({
  name: 'fluent-badge',
...
const BreadcrumbStyles$1 = css` ${display('inline-block')} :host{box-sizing: border-box;font-family: var(--body-font);font-size: var(--type-ramp-base-font-size);line-height: var(--type-ramp-base-line-height)}.list{display: flex}`;
...
FluentBreadcrumb = __decorate$2([customElement({
...
const BreadcrumbItemStyles$1 = css` ${display('inline-flex')} :host{background: transparent;box-sizing: border-box;fill: currentcolor;font-family: var(--body-font);font-size: var(--type-ramp-base-font-size);line-height: var(--type-ramp-base-line-height);min-width: calc(${heightNumber} * 1px);outline: none}.listitem{display: flex;align-items: center}.control{align-items: center;box-sizing: border-box;color: ${accentForegroundRestBehavior.var};cursor: pointer;display: flex;fill: inherit;outline: none;text-decoration: none;white-space: nowrap}.control:hover{color: ${accentForegroundHoverBehavior.var}}.control:active{color: ${accentForegroundActiveBehavior.var}}.control .content{position: relative}.control .content::before{content: "";display: block;height: calc(var(--outline-width) * 1px);left: 0;position: absolute;right: 0;top: calc(1em + 4px);width: 100%}.control:hover .content::before{background: ${accentForegroundHoverBehavior.var}}.control:active .content::before{background: ${accentForegroundActiveBehavior.var}}.control:${focusVisible} .content::before{background: ${neutralForegroundRestBehavior.var};height: calc(var(--focus-outline-width) * 1px)}:host(:not([href])), :host([aria-current]) .control{font-weight: 600;color: ${neutralForegroundRestBehavior.var};fill: currentcolor;cursor: default}:host([aria-current]) .control:hover .content::before{background: ${neutralForegroundRestBehavior.var}}.start{display: flex;margin-inline-end: 6px}.end{display: flex;margin-inline-start: 6px}.separator{display: flex;fill: ${neutralForegroundRestBehavior.var};margin: 0 6px}`.withBehaviors(accentForegroundActiveBehavior, accentForegroundHoverBehavior, accentForegroundRestBehavior, neutralForegroundRestBehavior, forcedColorsStylesheetBehavior(css` :host(:not([href])){color: ${SystemColors.ButtonText};fill: currentcolor}.control:hover .content::before, .control:${focusVisible} .content::before{background: ${SystemColors.LinkText}}.separator{fill: ${SystemColors.ButtonText}}`));
...
FluentBreadcrumbItem = __decorate$2([customElement({
...
__decorate$2([attr], FluentButton.prototype, "appearance", void 0);

FluentButton = __decorate$2([customElement({
  name: 'fluent-button',
...
const CardStyles$1 = css` ${display('block')} :host{--elevation: 4;display: block;contain: content;height: var(--card-height, 100%);width: var(--card-width, 100%);box-sizing: border-box;border-radius: calc(var(--elevated-corner-radius) * 1px);${elevation}}:host(:hover){--elevation: 8}:host(:focus-within){--elevation: 8}:host{content-visibility: auto}`.withBehaviors(neutralFillCardRestBehavior, forcedColorsStylesheetBehavior(css` :host{forced-color-adjust: none;background: ${SystemColors.Canvas};box-shadow: 0 0 0 1px ${SystemColors.CanvasText}}`));
...
FluentCard = __decorate$2([designSystemProvider({
  name: 'fluent-card',
...
FluentCheckbox = __decorate$2([customElement({
...
FluentCombobox = __decorate$2([customElement({
...
FluentDataGrid = __decorate$2([customElement({
...
FluentDataGridRow = __decorate$2([customElement({
...
FluentDataGridCell = __decorate$2([customElement({
...
const DialogStyles$1 = css` :host([hidden]){display: none}:host{--elevation: 14;--dialog-height: 480px;--dialog-width: 640px;display: block}.overlay{position: fixed;top: 0;left: 0;right: 0;bottom: 0;background: rgba(0, 0, 0, 0.3);touch-action: none}.positioning-region{display: flex;justify-content: center;position: fixed;top: 0;bottom: 0;left: 0;right: 0;overflow: auto}.control{${elevation} margin-top: auto;margin-bottom: auto;border-radius: calc(var(--elevated-corner-radius) * 1px);width: var(--dialog-width);height: var(--dialog-height);background: var(--background-color);z-index: 1;border: calc(var(--outline-width) * 1px) solid transparent}`;
...
FluentDialog = __decorate$2([customElement({
  name: 'fluent-dialog',
...
const DividerStyles$1 = css` ${display('block')} :host{box-sizing: content-box;height: 0;margin: calc(var(--design-unit) * 1px) 0;border: none;border-top: calc(var(--outline-width) * 1px) solid ${neutralDividerRestBehavior.var}}`.withBehaviors(neutralDividerRestBehavior);
...
FluentDivider = __decorate$2([customElement({
  name: 'fluent-divider',
...
const FlipperStyles$1 = css` ${display('inline-flex')} :host{width: calc(${heightNumber} * 1px);height: calc(${heightNumber} * 1px);justify-content: center;align-items: center;margin: 0;position: relative;fill: currentcolor;color: ${neutralForegroundRestBehavior.var};background: transparent;border: none;outline: none;padding: 0}:host::before{content: "";opacity: 0.8;background: ${neutralFillStealthRestBehavior.var};border: calc(var(--outline-width) * 1px) solid ${neutralOutlineRestBehavior.var};border-radius: 50%;position: absolute;top: 0;right: 0;left: 0;bottom: 0;transition: all 0.1s ease-in-out}.next, .previous{position: relative;${
/* Glyph size and margin-left is temporary -
  replace when adaptive typography is figured out */
''} width: 16px;height: 16px}:host(.disabled){opacity: var(--disabled-opacity);cursor: ${disabledCursor}}:host(:hover){cursor: pointer}:host(:hover)::before{background: ${neutralFillStealthHoverBehavior.var};border-color: ${neutralOutlineHoverBehavior.var}}:host(:${focusVisible}){outline: none}:host(:${focusVisible})::before{box-shadow: 0 0 0 1px ${neutralFocusBehavior.var} inset;border-color: ${neutralFocusBehavior.var}}:host(:active)::before{background: ${neutralFillStealthActiveBehavior.var};border-color: ${neutralOutlineActiveBehavior.var}}:host::-moz-focus-inner{border: 0}`.withBehaviors(neutralFillStealthActiveBehavior, neutralFillStealthHoverBehavior, neutralFillStealthRestBehavior, neutralFocusBehavior, neutralForegroundRestBehavior, neutralOutlineActiveBehavior, neutralOutlineHoverBehavior, neutralOutlineRestBehavior, forcedColorsStylesheetBehavior(css` :host{background: ${SystemColors.Canvas}}:host .next, :host .previous{color: ${SystemColors.ButtonText};fill: currentcolor}:host::before{background: ${SystemColors.Canvas};border-color: ${SystemColors.ButtonText}}:host(:hover)::before{forced-color-adjust: none;background: ${SystemColors.Highlight};border-color: ${SystemColors.ButtonText};opacity: 1}:host(:hover) .next, :host(:hover) .previous{forced-color-adjust: none;color: ${SystemColors.HighlightText};fill: currentcolor}:host(.disabled){opacity: 1}:host(.disabled)::before, :host(.disabled:hover)::before, :host(.disabled) .next, :host(.disabled) .previous, :host(.disabled:hover) .next, :host(.disabled:hover) .previous{forced-color-adjust: none;background: ${SystemColors.Canvas};border-color: ${SystemColors.GrayText};color: ${SystemColors.GrayText};fill: ${SystemColors.GrayText}}:host(:${focusVisible})::before{forced-color-adjust: none;border-color: ${SystemColors.Highlight};box-shadow: 0 0 0 2px ${SystemColors.Field}, 0 0 0 4px ${SystemColors.FieldText}}`));
...
FluentFlipper = __decorate$2([customElement({
  name: 'fluent-flipper',
...
const HorizontalScrollStyles$1 = css` ${display('block')} :host{--scroll-align: center;--scroll-item-spacing: 4px;contain: layout;position: relative}.scroll-view{overflow-x: auto;scrollbar-width: none}::-webkit-scrollbar{display: none}.content-container{align-items: var(--scroll-align);display: inline-flex;flex-wrap: nowrap;position: relative}.content-container ::slotted(*){margin-right: var(--scroll-item-spacing)}.content-container ::slotted(*:last-child){margin-right: 0}`;
...
FluentHorizontalScroll = __decorate$2([customElement({
...
FluentListbox = __decorate$2([customElement({
  name: 'fluent-listbox',
...
FluentOption = __decorate$2([customElement({
  name: 'fluent-option',
...
const MenuStyles$1 = css` ${display('block')} :host{--elevation: 11;background: ${neutralLayerFloatingBehavior.var};border: calc(var(--outline-width) * 1px) solid transparent;border-radius: var(--elevated-corner-radius);${elevation} margin: 0;border-radius: calc(var(--corner-radius) * 1px);padding: calc(var(--design-unit) * 1px) 0;max-width: 368px;min-width: 64px}:host([slot='submenu']){width: max-content;margin: 0 calc(var(--design-unit) * 1px)}::slotted(hr){box-sizing: content-box;height: 0;margin: 0;border: none;border-top: calc(var(--outline-width) * 1px) solid var(--neutral-divider-rest)}`.withBehaviors(neutralLayerFloatingBehavior, neutralDividerRestBehavior);
...
FluentMenu = __decorate$2([customElement({
  name: 'fluent-menu',
...
const MenuItemStyles$1 = css` ${display('grid')} :host{outline: none;box-sizing: border-box;height: calc(${heightNumber} * 1px);grid-template-columns: minmax(42px, auto) 1fr minmax(42px, auto);grid-template-rows: auto;justify-items: center;align-items: center;padding: 0;margin: 0 calc(var(--design-unit) * 1px);white-space: nowrap;overflow: hidden;color: ${neutralForegroundRestBehavior.var};fill: currentcolor;cursor: pointer;font-family: var(--body-font);font-size: var(--type-ramp-base-font-size);line-height: var(--type-ramp-base-line-height);border-radius: calc(var(--corner-radius) * 1px);border: calc(var(--outline-width) * 1px) solid transparent}:host(:${focusVisible}){border: calc(var(--outline-width) * 1px) solid ${neutralFocusBehavior.var};box-shadow: 0 0 0 calc((var(--focus-outline-width) - var(--outline-width)) * 1px) ${neutralFocusBehavior.var}}:host(:hover){background: ${neutralFillStealthHoverBehavior.var}}:host(:active){background: ${neutralFillStealthActiveBehavior.var}}:host(.disabled){cursor: ${disabledCursor};opacity: var(--disabled-opacity)}:host(.disabled:hover) .start, :host(.disabled:hover) .end, :host(.disabled:hover)::slotted(svg){fill: currentcolor}.content{grid-column-start: 2;justify-self: start;overflow: hidden;text-overflow: ellipsis}.start, .end, ::slotted(svg){${
/* Glyph size and margin-left is temporary -
  replace when adaptive typography is figured out */
''} width: 16px;height: 16px;display: flex}:host(:hover) .start, :host(:hover) .end, :host(:hover)::slotted(svg), :host(:active) .start, :host(:active) .end, :host(:active)::slotted(svg){fill: ${neutralForegroundRestBehavior.var}}:host([role="menuitemcheckbox"]), :host([role="menuitemradio"]){display: grid;grid-template-columns: auto auto 1fr minmax(42px, auto);align-items: center;min-height: 32px}:host .input-container{display: none}:host([role="menuitemcheckbox"]) .input-container, :host([role="menuitemradio"]) .input-container{display: grid;margin-inline-end: 10px}:host([role="menuitemcheckbox"]) .start, :host([role="menuitemradio"]) .start{grid-column-start: 2;margin-inline-end: 10px}:host([role="menuitemcheckbox"]) .content, :host([role="menuitemradio"]) .content{grid-column-start: 3}:host([role="menuitemcheckbox"]) .end, :host([role="menuitemradio"]) .end{grid-column-start: 4}:host .checkbox, :host .radio{display: flex;align-items: center;justify-content: center;position: relative;width: 20px;height: 20px;box-sizing: border-box;border: calc(var(--outline-width) * 1px) solid ${neutralForegroundRestBehavior.var};outline: none;margin-inline-start: 10px}:host .checkbox{border-radius: calc(var(--corner-radius) * 1px)}:host .radio{border-radius: 999px}:host .checkbox-indicator, :host .radio-indicator, ::slotted([slot="checkbox-indicator"]), ::slotted([slot="radio-indicator"]){display: none}:host([aria-checked="true"]) .checkbox-indicator, :host([aria-checked="true"]) ::slotted([slot="checkbox-indicator"]){width: 100%;height: 100%;display: block;fill: ${neutralForegroundRestBehavior.var};pointer-events: none}:host([aria-checked="true"]) .radio-indicator{position: absolute;top: 4px;left: 4px;right: 4px;bottom: 4px;border-radius: 999px;display: block;background: ${neutralForegroundRestBehavior.var};pointer-events: none}:host([aria-checked="true"]) ::slotted([slot="radio-indicator"]){display: block;pointer-events: none}`.withBehaviors(neutralFillStealthActiveBehavior, neutralFillStealthHoverBehavior, neutralFillStealthRestBehavior, neutralFocusBehavior, neutralForegroundRestBehavior, forcedColorsStylesheetBehavior(css` :host{forced-color-adjust: none;border-color: transparent;color: ${SystemColors.ButtonText};fill: ${SystemColors.ButtonText}}:host(:hover){background: ${SystemColors.Highlight};color: ${SystemColors.HighlightText}}:host(:hover) .start, :host(:hover) .end, :host(:hover)::slotted(svg), :host(:active) .start, :host(:active) .end, :host(:active)::slotted(svg){fill: ${SystemColors.HighlightText}}:host(:${focusVisible}){background: ${SystemColors.Highlight};border-color: ${SystemColors.ButtonText};box-shadow: 0 0 0 calc(var(--focus-outline-width) * 1px) inset ${SystemColors.HighlightText};color: ${SystemColors.HighlightText};fill: currentcolor}:host(.disabled), :host(.disabled:hover), :host(.disabled:hover) .start, :host(.disabled:hover) .end, :host(.disabled:hover)::slotted(svg){background: ${SystemColors.Canvas};color: ${SystemColors.GrayText};fill: currentcolor;opacity: 1}:host .checkbox, :host .radio{border-color: ${SystemColors.ButtonText};background: ${SystemColors.HighlightText}}:host([checked="true"]) .checkbox, :host([checked="true"]) .radio{background: ${SystemColors.HighlightText};border-color: ${SystemColors.HighlightText}}:host(:hover) .checkbox, :host(:hover) .radio, :host(:${focusVisible}) .checkbox, :host(:${focusVisible}) .radio, :host([checked="true"]:hover) .checkbox, :host([checked="true"]:hover) .radio, :host([checked="true"]:${focusVisible}) .checkbox, :host([checked="true"]:${focusVisible}) .radio{border-color: ${SystemColors.HighlightText}}:host([aria-checked="true"]){background: ${SystemColors.Highlight};color: ${SystemColors.HighlightText}}:host([aria-checked="true"]) .checkbox-indicator, :host([aria-checked="true"]) ::slotted([slot="checkbox-indicator"]), :host([aria-checked="true"]) ::slotted([slot="radio-indicator"]){fill: ${SystemColors.Highlight}}:host([aria-checked="true"]) .radio-indicator{background: ${SystemColors.Highlight}}`));
...
FluentMenuItem = __decorate$2([customElement({
...
__decorate$2([attr], FluentNumberField.prototype, "appearance", void 0);

FluentNumberField = __decorate$2([customElement({
...
FluentProgress = __decorate$2([customElement({
...
FluentProgressRing = __decorate$2([customElement({
...
const RadioStyles$1 = css` ${display('inline-flex')} :host{--input-size: calc((${heightNumber} / 2) + var(--design-unit));align-items: center;outline: none;margin: calc(var(--design-unit) * 1px) 0;${
/*
 * Chromium likes to select label text or the default slot when
 * the radio button is clicked. Maybe there is a better solution here?
 */
''} user-select: none;position: relative;flex-direction: row;transition: all 0.2s ease-in-out}.control{position: relative;width: calc(var(--input-size) * 1px);height: calc(var(--input-size) * 1px);box-sizing: border-box;border-radius: 50%;border: calc(var(--outline-width) * 1px) solid ${neutralOutlineRestBehavior.var};background: ${neutralFillInputRestBehavior.var};outline: none;cursor: pointer}.label__hidden{display: none;visibility: hidden}.label{font-family: var(--body-font);color: ${neutralForegroundRestBehavior.var};${
/* Need to discuss with Brian how HorizontalSpacingNumber can work. https://github.com/microsoft/fast/issues/2766 */
''} padding-inline-start: calc(var(--design-unit) * 2px + 2px);margin-inline-end: calc(var(--design-unit) * 2px + 2px);cursor: pointer;font-size: var(--type-ramp-base-font-size);line-height: var(--type-ramp-base-line-height)}.control, .checked-indicator{flex-shrink: 0}.checked-indicator{position: absolute;top: 5px;left: 5px;right: 5px;bottom: 5px;border-radius: 50%;display: inline-block;background: ${neutralForegroundRestBehavior.var};fill: ${neutralForegroundRestBehavior.var};opacity: 0;pointer-events: none}:host(:enabled) .control:hover{background: ${neutralFillInputHoverBehavior.var};border-color: ${neutralOutlineHoverBehavior.var}}:host(:enabled) .control:active{background: ${neutralFillInputActiveBehavior.var};border-color: ${neutralOutlineActiveBehavior.var}}:host(:${focusVisible}) .control{box-shadow: 0 0 0 2px var(--background-color), 0 0 0 4px ${neutralFocusBehavior.var};border-color: ${neutralFocusBehavior.var}}:host(.disabled) .label, :host(.readonly) .label, :host(.readonly) .control, :host(.disabled) .control{cursor: ${disabledCursor}}:host(.checked) .checked-indicator{opacity: 1}:host(.disabled){opacity: var(--disabled-opacity)}`.withBehaviors(neutralFillActiveBehavior, neutralFillInputHoverBehavior, neutralFillInputRestBehavior, neutralFocusBehavior, neutralForegroundRestBehavior, neutralOutlineActiveBehavior, neutralOutlineHoverBehavior, neutralOutlineRestBehavior, neutralFillInputActiveBehavior, forcedColorsStylesheetBehavior(css` .control{forced-color-adjust: none;border-color: ${SystemColors.FieldText};background: ${SystemColors.Field}}:host(:enabled) .control:hover, .control:active{border-color: ${SystemColors.Highlight};background: ${SystemColors.Field}}:host(:${focusVisible}) .control{border-color: ${SystemColors.Highlight};box-shadow: 0 0 0 2px ${SystemColors.Field}, 0 0 0 4px ${SystemColors.FieldText}}:host(.checked:${focusVisible}:enabled) .control{border-color: ${SystemColors.Highlight};box-shadow: 0 0 0 2px ${SystemColors.Field}, 0 0 0 4px ${SystemColors.FieldText}}:host(.checked:enabled) .control:hover, .control:active{border-color: ${SystemColors.Highlight};background: ${SystemColors.Highlight}}:host(.checked) .checked-indicator{background: ${SystemColors.Highlight};fill: ${SystemColors.Highlight}}:host(.checked) .control:hover .checked-indicator{background: ${SystemColors.HighlightText};fill: ${SystemColors.HighlightText}}:host(.disabled){forced-color-adjust: none;opacity: 1}:host(.disabled) .label{color: ${SystemColors.GrayText}}:host(.disabled) .control, :host(.checked.disabled) .control:hover, .control:active{background: ${SystemColors.Field};border-color: ${SystemColors.GrayText}}:host(.disabled) .checked-indicator, :host(.checked.disabled) .control:hover .checked-indicator{fill: ${SystemColors.GrayText};background: ${SystemColors.GrayText}}`));
...
FluentRadio = __decorate$2([customElement({
  name: 'fluent-radio',
...
FluentRadioGroup = __decorate$2([customElement({
...
FluentSelect = __decorate$2([customElement({
  name: 'fluent-select',
...
const SkeletonStyles$1 = css` ${display('block')} :host{--skeleton-fill-default: #e1dfdd;overflow: hidden;width: 100%;position: relative;background-color: var(--skeleton-fill, var(--skeleton-fill-default));--skeleton-animation-gradient-default: linear-gradient( 270deg, var(--skeleton-fill, var(--skeleton-fill-default)) 0%, #f3f2f1 51.13%, var(--skeleton-fill, var(--skeleton-fill-default)) 100% );--skeleton-animation-timing-default: ease-in-out}:host(.rect){border-radius: calc(var(--corner-radius) * 1px)}:host(.circle){border-radius: 100%;overflow: hidden}object{position: absolute;width: 100%;height: auto;z-index: 2}object img{width: 100%;height: auto}${display('block')} span.shimmer{position: absolute;width: 100%;height: 100%;background-image: var(--skeleton-animation-gradient, var(--skeleton-animation-gradient-default));background-size: 0px 0px / 90% 100%;background-repeat: no-repeat;background-color: var(--skeleton-animation-fill, ${neutralFillRestBehavior.var});animation: shimmer 2s infinite;animation-timing-function: var(--skeleton-animation-timing, var(--skeleton-timing-default));animation-direction: normal;z-index: 1}::slotted(svg){z-index: 2}::slotted(.pattern){width: 100%;height: 100%}@keyframes shimmer{0%{transform: translateX(-100%)}100%{transform: translateX(100%)}}`.withBehaviors(neutralFillRestBehavior);
...
FluentSkeleton = __decorate$2([customElement({
...
const SliderStyles$1 = css` ${display('inline-grid')} :host{--thumb-size: calc(${heightNumber} * 0.5);--thumb-translate: calc(var(--thumb-size) * 0.5);--track-overhang: calc((var(--design-unit) / 2) * -1);--track-width: var(--design-unit);align-items: center;width: 100%;margin: calc(var(--design-unit) * 1px) 0;user-select: none;box-sizing: border-box;border-radius: calc(var(--corner-radius) * 1px);outline: none;cursor: pointer}:host(.horizontal) .positioning-region{position: relative;margin: 0 8px;display: grid;grid-template-rows: calc(var(--thumb-size) * 1px) 1fr}:host(.vertical) .positioning-region{position: relative;margin: 0 8px;display: grid;height: 100%;grid-template-columns: calc(var(--thumb-size) * 1px) 1fr}:host(:${focusVisible}) .thumb-cursor{box-shadow: 0 0 0 2px var(--background-color), 0 0 0 4px ${neutralFocusBehavior.var}}.thumb-container{position: absolute;height: calc(var(--thumb-size) * 1px);width: calc(var(--thumb-size) * 1px);transition: all 0.2s ease}.thumb-cursor{border: none;width: calc(var(--thumb-size) * 1px);height: calc(var(--thumb-size) * 1px);background: ${neutralForegroundRestBehavior.var};border-radius: 50%}.thumb-cursor:hover{background: ${neutralForegroundHoverBehavior.var};border-color: ${neutralOutlineHoverBehavior.var}}.thumb-cursor:active{background: ${neutralForegroundActiveBehavior.var}}:host(.horizontal) .thumb-container{transform: translateX(calc(var(--thumb-translate) * 1px))}:host(.vertical) .thumb-container{transform: translateY(calc(var(--thumb-translate) * 1px))}:host(.horizontal){min-width: calc(var(--thumb-size) * 1px)}:host(.horizontal) .track{right: calc(var(--track-overhang) * 1px);left: calc(var(--track-overhang) * 1px);align-self: start;margin-top: calc((var(--design-unit) + calc(var(--density) + 2)) * 1px);height: calc(var(--track-width) * 1px)}:host(.vertical) .track{top: calc(var(--track-overhang) * 1px);bottom: calc(var(--track-overhang) * 1px);margin-inline-start: calc((var(--design-unit) + calc(var(--density) + 2)) * 1px);width: calc(var(--track-width) * 1px);height: 100%}.track{background: ${neutralOutlineRestBehavior.var};position: absolute}:host(.vertical){height: 100%;min-height: calc(var(--design-unit) * 60px);min-width: calc(var(--design-unit) * 20px)}:host(.disabled), :host(.readonly){cursor: ${disabledCursor}}:host(.disabled){opacity: var(--disabled-opacity)}`.withBehaviors(neutralFocusBehavior, neutralForegroundActiveBehavior, neutralForegroundHoverBehavior, neutralForegroundRestBehavior, neutralOutlineHoverBehavior, neutralOutlineRestBehavior, forcedColorsStylesheetBehavior(css` .thumb-cursor{forced-color-adjust: none;border-color: ${SystemColors.FieldText};background: ${SystemColors.FieldText}}.thumb-cursor:hover, .thumb-cursor:active{background: ${SystemColors.Highlight}}.track{forced-color-adjust: none;background: ${SystemColors.FieldText}}:host(:${focusVisible}) .thumb-cursor{background: ${SystemColors.Highlight};border-color: ${SystemColors.Highlight};box-shadow: 0 0 0 2px ${SystemColors.Field}, 0 0 0 4px ${SystemColors.FieldText}}:host(.disabled){opacity: 1}:host(.disabled) .track, :host(.disabled) .thumb-cursor{forced-color-adjust: none;background: ${SystemColors.GrayText}}`));
...
FluentSlider = __decorate$2([customElement({
  name: 'fluent-slider',
...
FluentSliderLabel = __decorate$2([customElement({
...
FluentSwitch = __decorate$2([customElement({
  name: 'fluent-switch',
...
FluentTab = __decorate$2([customElement({
  name: 'fluent-tab',
...
const TabPanelStyles$1 = css` ${display('flex')} :host{box-sizing: border-box;font-family: var(--body-font);${
/* Font size, weight, and line height are temporary -
 replace when adaptive typography is figured out */
''} font-size: 12px;font-weight: 400;line-height: 18px;padding: 0 calc((6 + (var(--design-unit) * 2 * var(--density))) * 1px)}`;
...
FluentTabPanel = __decorate$2([customElement({
...
FluentTabs = __decorate$2([customElement({
  name: 'fluent-tabs',
...
const TextAreaFilledStyles = css` :host([appearance='filled']) .control{background: ${neutralFillRestBehavior.var};border-color: transparent}:host([appearance='filled']:hover:not([disabled])) .control{background: ${neutralFillHoverBehavior.var};border-color: transparent}:host([appearance='filled']:focus-within:not([disabled])) .control{border-color: transparent;box-shadow: none}${FillStateStyles}`.withBehaviors(accentFillRestBehavior, neutralFillHoverBehavior, neutralFillRestBehavior, forcedColorsStylesheetBehavior(css` :host([appearance='filled']:hover:not([disabled])) .control, :host([appearance='filled']:focus-within:not([disabled])) .control{background: ${SystemColors.Field};border-color: ${SystemColors.FieldText}}:host([appearance='filled']:not([disabled]):active)::after, :host([appearance='filled']:not([disabled]):focus-within:not(:active))::after{border-bottom-color: ${SystemColors.Highlight}}`));
const TextAreaStyles$1 = css` ${display('inline-flex')} :host{font-family: var(--body-font);outline: none;user-select: none;position: relative;flex-direction: column;vertical-align: bottom}.control{box-sizing: border-box;position: relative;color: ${neutralForegroundRestBehavior.var};background: ${neutralFillInputRestBehavior.var};border-radius: calc(var(--corner-radius) * 1px);border: calc(var(--outline-width) * 1px) solid ${neutralOutlineRestBehavior.var};height: calc(${heightNumber} * 2px);font: inherit;font-size: var(--type-ramp-base-font-size);line-height: var(--type-ramp-base-line-height);padding: calc(var(--design-unit) * 1.5px) calc(var(--design-unit) * 2px + 1px);width: 100%;resize: none}.control:hover:enabled{background: ${neutralFillInputHoverBehavior.var};border-color: ${neutralOutlineHoverBehavior.var}}.control:hover, .control:${focusVisible}, .control:disabled, .control:active{outline: none}:host(:focus-within) .control{border-color: ${neutralFocusBehavior.var};box-shadow: 0 0 0 1px ${neutralFocusBehavior.var} inset}:host(.resize-both) .control{resize: both}:host(.resize-horizontal) .control{resize: horizontal}:host(.resize-vertical) .control{resize: vertical}.label__hidden{display: none;visibility: hidden}.label{display: block;color: ${neutralForegroundRestBehavior.var};cursor: pointer;$font-size: var(--type-ramp-base-font-size);line-height: var(--type-ramp-base-line-height);margin-bottom: 4px}:host([disabled]) .label, :host([readonly]) .label, :host([readonly]) .control, :host([disabled]) .control{cursor: ${disabledCursor}}:host([disabled]){opacity: var(--disabled-opacity)}`.withBehaviors(appearanceBehavior('filled', TextAreaFilledStyles), neutralFillInputHoverBehavior, neutralFillInputRestBehavior, neutralFocusBehavior, neutralForegroundRestBehavior, neutralOutlineHoverBehavior, neutralOutlineRestBehavior, forcedColorsStylesheetBehavior(css` :host([disabled]){opacity: 1}::placeholder, ::-webkit-input-placeholder{color: ${SystemColors.FieldText}}:host([disabled]) ::placeholder, :host([disabled]) ::-webkit-input-placeholder, :host([disabled]) .label{color: ${SystemColors.GrayText}}`));
...
__decorate$2([attr], FluentTextArea.prototype, "appearance", void 0);

FluentTextArea = __decorate$2([customElement({
...
__decorate$2([attr], FluentTextField.prototype, "appearance", void 0);

FluentTextField = __decorate$2([customElement({
...
FluentTooltip = __decorate$2([customElement({
  name: 'fluent-tooltip',
...
const ltr = css` .expand-collapse-glyph{transform: rotate(-45deg)}:host(.nested) .expand-collapse-button{left: var(--expand-collapse-button-nested-width, calc(${heightNumber} * -1px))}:host([selected])::after{left: calc(var(--focus-outline-width) * 1px)}:host([expanded]) > .positioning-region .expand-collapse-glyph{transform: rotate(0deg)}`;
const rtl = css` .expand-collapse-glyph{transform: rotate(135deg)}:host(.nested) .expand-collapse-button{right: var(--expand-collapse-button-nested-width, calc(${heightNumber} * -1px))}:host([selected])::after{right: calc(var(--focus-outline-width) * 1px)}:host([expanded]) > .positioning-region .expand-collapse-glyph{transform: rotate(90deg)}`;
...
/* Width and Height should be based off calc(glyph-size-number + (design-unit * 4) * 1px) -
  update when density story is figured out */
''} width: calc((${expandCollapseButtonSize} + (var(--design-unit) * 2)) * 1px);height: calc((${expandCollapseButtonSize} + (var(--design-unit) * 2)) * 1px);padding: 0;display: flex;justify-content: center;align-items: center;cursor: pointer;margin: 0 6px}.expand-collapse-glyph{${
/* Glyph size is temporary -
replace when glyph-size var is added */
''} width: 16px;height: 16px;transition: transform 0.1s linear;${
/* transform needs to be localized */
''} transform: rotate(-45deg);pointer-events: none;fill: ${neutralForegroundRestBehavior.var}}.start, .end{display: flex;fill: currentcolor}::slotted(svg){${
/* Glyph size is temporary -
replace when glyph-size var is added */
...
''} background: ${accentForegroundRestBehavior.var};border-radius: calc(var(--corner-radius) * 1px)}::slotted(fluent-tree-item){--tree-item-nested-width: 1em;--expand-collapse-button-nested-width: calc(${heightNumber} * -1px)}`.withBehaviors(accentForegroundRestBehavior, expandCollapseHoverBehavior, neutralFillStealthSelectedBehavior, neutralFillStealthActiveBehavior, neutralFillStealthHoverBehavior, neutralFillStealthRestBehavior, neutralFocusBehavior, neutralFocusInnerAccentBehavior, neutralForegroundActiveBehavior, neutralForegroundRestBehavior, selectedExpandCollapseHoverBehavior, new DirectionalStyleSheetBehavior(ltr, rtl), forcedColorsStylesheetBehavior(css` :host{forced-color-adjust: none;border-color: transparent;background: ${SystemColors.Field};color: ${SystemColors.FieldText}}:host .content-region{color: ${SystemColors.FieldText}}:host .content-region .expand-collapse-glyph, :host .content-region .start, :host .content-region .end{fill: ${SystemColors.FieldText}}:host .positioning-region:hover, :host([selected]) .positioning-region{background: ${SystemColors.Highlight}}:host .positioning-region:hover .content-region, :host([selected]) .positioning-region .content-region{color: ${SystemColors.HighlightText}}:host .positioning-region:hover .content-region .expand-collapse-glyph, :host .positioning-region:hover .content-region .start, :host .positioning-region:hover .content-region .end, :host([selected]) .content-region .expand-collapse-glyph, :host([selected]) .content-region .start, :host([selected]) .content-region .end{fill: ${SystemColors.HighlightText}}:host([selected])::after{background: ${SystemColors.Field}}:host(:${focusVisible}) .positioning-region{border-color: ${SystemColors.FieldText};box-shadow: 0 0 0 2px inset ${SystemColors.Field};color: ${SystemColors.FieldText}}:host([disabled]) .content-region, :host([disabled]) .positioning-region:hover .content-region{opacity: 1;color: ${SystemColors.GrayText}}:host([disabled]) .content-region .expand-collapse-glyph, :host([disabled]) .content-region .start, :host([disabled]) .content-region .end, :host([disabled]) .positioning-region:hover .content-region .expand-collapse-glyph, :host([disabled]) .positioning-region:hover .content-region .start, :host([disabled]) .positioning-region:hover .content-region .end{fill: ${SystemColors.GrayText}}:host([disabled]) .positioning-region:hover{background: ${SystemColors.Field}}.expand-collapse-glyph, .start, .end{fill: ${SystemColors.FieldText}}:host(.nested) .expand-collapse-button:hover{background: ${SystemColors.Field}}:host(.nested) .expand-collapse-button:hover .expand-collapse-glyph{fill: ${SystemColors.FieldText}}`));
...
FluentTreeItem = __decorate$2([customElement({
...
const TreeViewStyles$1 = css` :host([hidden]){display: none}${display('flex')} :host{flex-direction: column;align-items: stretch;min-width: fit-content;font-size: 0}:host:focus-visible{outline: none}`;
...
FluentTreeView = __decorate$2([customElement({
...
export { $global, ARIAGlobalStatesAndProperties, AccentButtonStyles, Accordion, AccordionExpandMode, AccordionItem, AccordionItemStyles, AccordionItemTemplate, AccordionStyles, AccordionTemplate, Anchor, AnchorStyles, AnchorTemplate, AnchoredRegion, AnchoredRegionStyles, AnchoredRegionTemplate, AttachedBehaviorHTMLDirective, AttributeDefinition, Badge, BadgeStyles, BadgeTemplate, BaseButtonStyles, BaseProgress, BindingBehavior, Breadcrumb, BreadcrumbItem, BreadcrumbItemStyles, BreadcrumbItemTemplate, BreadcrumbStyles, BreadcrumbTemplate, Button, ButtonStyles, ButtonTemplate, CSSCustomPropertyBehavior, CSSDirective, Card, CardStyles, CardTemplate, Checkbox, CheckboxStyles, CheckboxTemplate, ChildrenBehavior, Combobox, ComboboxAutocomplete, ComboboxStyles, ComboboxTemplate, ComponentPresentation, ConstructableStylesCustomPropertyManager, Container, ContainerConfiguration, ContainerImpl, Controller, DI, DOM, DataGrid, DataGridCell, DataGridCellStyles, DataGridCellTypes, DataGridRow, DataGridRowStyles, DataGridRowTypes, DataGridStyles, DefaultComponentPresentation, DefaultResolver, DelegatesARIAButton, DelegatesARIACombobox, DelegatesARIALink, DelegatesARIAListbox, DelegatesARIASelect, DelegatesARIATextbox, DesignSystem, DesignSystemDefaults, DesignSystemProvider, DesignSystemProviderTemplate, DesignSystemRegistrationContext, Dialog, DialogStyles, DialogTemplate, DirectionalStyleSheetBehavior, Disclosure, DisclosureTemplate, Divider, DividerRole, DividerStyles, DividerTemplate, ElementStyles, ExecutionContext, FASTElement, FASTElementDefinition, FactoryImpl, FillStateStyles, Flipper, FlipperDirection, FlipperStyles, FlipperTemplate, FluentAccordion, FluentAccordionItem, FluentAnchor, FluentAnchoredRegion, FluentBadge, FluentBreadcrumb, FluentBreadcrumbItem, FluentButton, FluentCard, FluentCheckbox, FluentCombobox, FluentDataGrid, FluentDataGridCell, FluentDataGridRow, FluentDesignSystemProvider, FluentDialog, FluentDivider, FluentFlipper, FluentHorizontalScroll, FluentListbox, FluentMenu, FluentMenuItem, FluentNumberField, FluentOption, FluentProgress, FluentProgressRing, FluentRadio, FluentRadioGroup, FluentSelect, FluentSkeleton, FluentSlider, FluentSliderLabel, FluentSwitch, FluentTab, FluentTabPanel, FluentTabs, FluentTextArea, FluentTextField, FluentTooltip, FluentTreeItem, FluentTreeView, FormAssociated, FoundationElement, GenerateHeaderOptions, HTMLBindingDirective, HTMLDirective, HTMLView, HorizontalScroll, HorizontalScrollStyles, HorizontalScrollTemplate, HypertextStyles, LightweightButtonStyles, Listbox, ListboxOption, ListboxOptionTemplate, ListboxRole, ListboxStyles, ListboxTemplate, MatchMediaBehavior, MatchMediaStyleSheetBehavior, Menu, MenuItem, MenuItemRole, MenuItemStyles, MenuItemTemplate, MenuStyles, MenuTemplate, NumberField, NumberFieldStyles, NumberFieldTemplate, Observable, OptionStyles, OutlineButtonStyles, PaletteType, ProgressRingStyles, ProgressRingTemplate, ProgressStyles, ProgressTemplate, PropertyChangeNotifier, PropertyStyleSheetBehavior, Radio, RadioGroup, RadioGroupStyles, RadioGroupTemplate, RadioStyles, RadioTemplate, RefBehavior, Registration, RepeatBehavior, RepeatDirective, ResolverBuilder, ResolverImpl, Select, SelectPosition, SelectRole, SelectStyles, SelectTemplate, ServiceLocator, Skeleton, SkeletonStyles, SkeletonTemplate, Slider, SliderLabel, SliderLabelStyles, SliderLabelTemplate, SliderMode, SliderStyles, SliderTemplate, SlottedBehavior, StandardLuminance, StartEnd, StealthButtonStyles, StyleElementCustomPropertyManager, SubscriberSet, Switch, SwitchStyles, SwitchTemplate, Tab, TabPanel, TabPanelStyles, TabPanelTemplate, TabStyles, TabTemplate, Tabs, TabsOrientation, TabsStyles, TabsTemplate, TargetedHTMLDirective, TextArea, TextAreaResize, TextAreaStyles, TextAreaTemplate, TextField, TextFieldStyles, TextFieldTemplate, TextFieldType, Tooltip, TooltipPosition, TooltipStyles, TreeItem, TreeItemStyles, TreeItemTemplate, TreeView, TreeViewStyles, TreeViewTemplate, ViewTemplate, accentFill, accentFillActive, accentFillActiveBehavior, accentFillFocusBehavior, accentFillHover, accentFillHoverBehavior, accentFillLarge, accentFillLargeActive, accentFillLargeActiveBehavior, accentFillLargeFocusBehavior, accentFillLargeHover, accentFillLargeHoverBehavior, accentFillLargeRest, accentFillLargeRestBehavior, accentFillLargeSelected, accentFillLargeSelectedBehavior, accentFillRest, accentFillRestBehavior, accentFillSelected, accentFillSelectedBehavior, accentForeground, accentForegroundActive, accentForegroundActiveBehavior, accentForegroundCut, accentForegroundCutLarge, accentForegroundCutRestBehavior, accentForegroundFocusBehavior, accentForegroundHover, accentForegroundHoverBehavior, accentForegroundLarge, accentForegroundLargeActive, accentForegroundLargeActiveBehavior, accentForegroundLargeFocusBehavior, accentForegroundLargeHover, accentForegroundLargeHoverBehavior, accentForegroundLargeRest, accentForegroundLargeRestBehavior, accentForegroundRest, accentForegroundRestBehavior, all, ambientShadow, applyMixins, attr, booleanConverter, children, compileTemplate, composedParent, createColorPalette, createDataGridCellTemplate, createDataGridRowTemplate, createDataGridTemplate, createMenuItemTemplate, createTooltipTemplate, css, cssCustomPropertyBehaviorFactory, customElement, darkModeStylesheetBehavior, defaultExecutionContext, defineDesignSystemProvider, designSystemConsumerBehavior, designSystemProperty, designSystemProvider, directionalShadow, disabledCursor, display, elements, elevation, emptyArray, enableArrayObservation, endTemplate, focusVisible, forcedColorsStylesheetBehavior, getDirection, heightNumber, hidden, html, ignore, inject, inlineEndBehavior, inlineStartBehavior, isDarkMode, isDesignSystemConsumer, isListboxOption, isTreeItemElement, lazy, lightModeStylesheetBehavior, matchMediaStylesheetBehaviorFactory, neutralContrastFill, neutralContrastFillActive, neutralContrastFillActiveBehavior, neutralContrastFillFocusBehavior, neutralContrastFillHover, neutralContrastFillHoverBehavior, neutralContrastFillRest, neutralContrastFillRestBehavior, neutralContrastForegroundRestBehavior, neutralDividerRest, neutralDividerRestBehavior, neutralFill, neutralFillActive, neutralFillActiveBehavior, neutralFillCard, neutralFillCardRestBehavior, neutralFillFocusBehavior, neutralFillHover, neutralFillHoverBehavior, neutralFillInput, neutralFillInputActive, neutralFillInputActiveBehavior, neutralFillInputFocusBehavior, neutralFillInputHover, neutralFillInputHoverBehavior, neutralFillInputRest, neutralFillInputRestBehavior, neutralFillInputSelected, neutralFillRest, neutralFillRestBehavior, neutralFillSelected, neutralFillSelectedBehavior, neutralFillStealth, neutralFillStealthActive, neutralFillStealthActiveBehavior, neutralFillStealthFocusBehavior, neutralFillStealthHover, neutralFillStealthHoverBehavior, neutralFillStealthRest, neutralFillStealthRestBehavior, neutralFillStealthSelected, neutralFillStealthSelectedBehavior, neutralFillToggle, neutralFillToggleActive, neutralFillToggleActiveBehavior, neutralFillToggleFocusBehavior, neutralFillToggleHover, neutralFillToggleHoverBehavior, neutralFillToggleRest, neutralFillToggleRestBehavior, neutralFocus, neutralFocusBehavior, neutralFocusInnerAccent, neutralFocusInnerAccentBehavior, neutralForeground, neutralForegroundActive, neutralForegroundActiveBehavior, neutralForegroundFocusBehavior, neutralForegroundHint, neutralForegroundHintBehavior, neutralForegroundHintLarge, neutralForegroundHintLargeBehavior, neutralForegroundHover, neutralForegroundHoverBehavior, neutralForegroundRest, neutralForegroundRestBehavior, neutralForegroundToggle, neutralForegroundToggleBehavior, neutralForegroundToggleLarge, neutralForegroundToggleLargeBehavior, neutralLayerCard, neutralLayerCardBehavior, neutralLayerCardContainer, neutralLayerCardContainerBehavior, neutralLayerFloating, neutralLayerFloatingBehavior, neutralLayerL1, neutralLayerL1Alt, neutralLayerL1AltBehavior, neutralLayerL1Behavior, neutralLayerL2, neutralLayerL2Behavior, neutralLayerL3, neutralLayerL3Behavior, neutralLayerL4, neutralLayerL4Behavior, neutralOutline, neutralOutlineActive, neutralOutlineActiveBehavior, neutralOutlineContrast, neutralOutlineContrastActive, neutralOutlineContrastHover, neutralOutlineContrastRest, neutralOutlineFocusBehavior, neutralOutlineHover, neutralOutlineHoverBehavior, neutralOutlineRest, neutralOutlineRestBehavior, newInstanceForScope, newInstanceOf, nullableNumberConverter, observable, optional, palette, parseColorString, ref, repeat, setCurrentEvent, singleton, slotted, startTemplate, supportsElementInternals, transient, validateKey, volatile, when, whitespaceFilter };
