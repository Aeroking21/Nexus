...
let MgtTasks = class MgtTasks extends MgtTemplatedComponent {
    ...
    `;
        ...
        if (!this.newTaskVisible) {
            const planId = (_a = task === null || task === void 0 ? void 0 : task._raw) === null || _a === void 0 ? void 0 : _a.planId;
            if (planId) {
                const group = this._groups.filter(group => group.id === planId);
                assignedGroupId = (_b = group.pop()) === null || _b === void 0 ? void 0 : _b.containerId;
            }
        }
