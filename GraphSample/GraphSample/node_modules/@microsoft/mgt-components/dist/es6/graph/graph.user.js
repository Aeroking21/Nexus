...
export function getUsers(graph, userFilters = '', top = 10) {
 ...
 * @returns {Promise<User[]>}
 */
export function getUsersForUserIds(graph, userIds, searchInput = '', userFilters = '') {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @returns {Promise<User[]>}
 */
export function findUsers(graph, query, top = 10, userFilters = '') {
    return __awaiter(this, void 0, void 0, function* () {
        const scopes = 'User.ReadBasic.All';
 ...
 * @returns {(Promise<User[]>)}
 */
export function findGroupMembers(graph, query, groupId, top = 10, personType = PersonType.person, transitive = false, userFilters = '', peopleFilters = '') {
    return __awaiter(this, void 0, void 0, function* () {
...
export function findUsersFromGroupIds(graph, query, groupIds, top = 10, personType = PersonType.person, transitive = false, groupFilters = '') {
    return __awaiter(this, void 0, void 0, function* () {
        const users = [];
